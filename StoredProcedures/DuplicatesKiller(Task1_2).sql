...
BEGIN
    ...
    ;WITH resolvePlayersDupplicate AS -- потом вычищаем игроков, однофамильцев играющих за разные клубы с одинаковым номером
        (
            SELECT PlayerId, Surname, Name, Number, ClubId,
    ...
    DELETE playerItem FROM PlayerClubItems playerItem -- удаляем связи с неактуальными игроками
